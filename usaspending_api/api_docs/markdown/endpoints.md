...
|[/api/v2/search/spending_by_category/funding_subagency/](/api/v2/search/spending_by_category/naics/)|POST| Returns data that is grouped in preset units to support the Spending by NAICS code data visualizations on USAspending.gov's Advanced Search page|
