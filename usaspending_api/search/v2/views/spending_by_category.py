...
from usaspending_api.search.v2.views.spending_by_category_views.spending_by_naics import NaicsView
...
class SpendingByCategoryVisualizationViewSet(APIView):
    ...
    def post(self, request: Request) -> Response:
        ...
        if validated_payload["category"] == "awarding_agency":
            ...
            response = NaicsView().perform_search(validated_payload, original_filters)
        else:
