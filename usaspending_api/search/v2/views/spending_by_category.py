...
class SpendingByCategoryVisualizationViewSet(APIView):
    ...
    def post(self, request: Request) -> Response:
        ...
        elif validated_payload["category"] == "recipient_parent_duns":
            response = ParentRecipientViewSet().perform_search(validated_payload, original_filters)
        elif validated_payload["category"] == "recipient_duns":
            response = RecipientViewSet().perform_search(validated_payload, original_filters)
        else:
